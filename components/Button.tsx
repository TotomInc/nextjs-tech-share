...
>(
  ({ children, variant = "primary", ...props }, ref) => (
    <button
      ...
      className={twMerge(
        "flex shrink-0 items-center justify-center gap-1.5 px-4 py-2.5 text-sm rounded-lg font-semibold cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-1",
        variant === "primary" &&
